...
class TranslateDivergenceDamping(TranslateD_SW):
    def __init__(self, grid):
        super().__init__(grid)
        self.in_vars['data_vars'] = {'u': {}, 'v': {}, 'va': {}, 'ptc': {},
                                     'vort': {}, 'ua': {},
                                     'divg_d': {},
                                     'vc': {}, 'uc': {},
                                     'delpc': {}, 'ke': {},
        ...
        self.out_vars = {'vort': {}, 'ke': {'iend': grid.ied + 1, 'jend': grid.jed + 1}, 'delpc': {}}

    def compute(self, inputs):
        return self.column_split_compute(inputs,  dd.compute, {'nord': 'nord_col', 'd2_bg': 'd2_bg'})
    '''
