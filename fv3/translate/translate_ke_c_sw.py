...
class TranslateKE_C_SW(TranslateFortranData2Py):
    def __init__(self, grid):
        ...
        self.in_vars['data_vars'] = {'uc': {}, 'vc': {}, 'u': {}, 'v': {}, 'ua': {}, 'va': {}}
        self.in_vars['parameters'] = ['dt2']
        self.out_vars = {'ke_c':  {'istart': grid.is_-1, 'iend': grid.ie+1,  'jstart': grid.js-1, 'jend': grid.je+1}, 'vort_c':  {'istart': grid.is_-1, 'iend': grid.ie+1,  'jstart': grid.js-1, 'jend': grid.je+1}}
