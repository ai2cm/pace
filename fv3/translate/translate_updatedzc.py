...
class TranslateUpdateDzC(TranslateFortranData2Py):
    def __init__(self, grid):
        ...
        self.in_vars['data_vars'] = {'dp_ref': {'serialname': 'dp0'}, 'zs': {}, 'ut': {'serialname': 'utc'},
                                     'vt': {'serialname': 'vtc'}, 'gz_in': {'serialname': 'gz'}, 'ws3': {'serialname': 'ws'}}
        self.in_vars['parameters'] = ['dt2']
        self.out_vars = {'gz': grid.default_buffer_k_dict(), 'ws': {'kstart': -1, 'kend': None}}
