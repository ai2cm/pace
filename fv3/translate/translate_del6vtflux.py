...
class TranslateDel6VtFlux(TranslateD_SW):
    def __init__(self, grid):
        ...
        self.in_vars['data_vars'] = {'q': {'serialname': 'wq'}, 'd2': {'serialname':'wd2'}, 'fx2': grid.x3d_domain_dict(), 'fy2': grid.y3d_domain_dict(),
                                     'damp_c': {'serialname': 'damp4'}, 'nord_column': {'serialname': 'nord_w'}}
        self.in_vars['parameters'] = []
        self.out_vars = {'fx2': grid.x3d_domain_dict(), 'fy2': grid.y3d_domain_dict(), 'd2': {'serialname': 'wd2'}, 'q': {'serialname': 'wq'}}
