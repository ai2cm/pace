...
def enable_selective_validation():
    ...
    pace.fv3core.stencils.divergence_damping.DivergenceDamping = get_selective_class(
        pace.fv3core.stencils.divergence_damping.DivergenceDamping,
        {
    ...
    pace.fv3core.stencils.fv_dynamics.DynamicalCore = get_selective_class(
        pace.fv3core.stencils.fv_dynamics.DynamicalCore,
        {
