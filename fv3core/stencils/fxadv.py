...
def corner_ut_stencil(
    ...
    with computation(PARALLEL), interval(...):
        ut[0, 0, 0] = (
            ...
            * 1.0
            / (1.0 - 0.0625 * cosa_u[0, 0] * cosa_v[vi, vj])
        )
