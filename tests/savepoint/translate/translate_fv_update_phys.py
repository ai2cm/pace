...
class TranslateFVUpdatePhys(ParallelTranslate2Py):
    ...
    inputs = {
        ...
        "edge_vect_n": {
            "name": "edge vector north",
            "dims": [fv3util.X_DIM],
            "units": "",
        },
        "edge_vect_s": {
            "name": "edge vector south",
            "dims": [fv3util.X_DIM],
            "units": "",
        },
        "edge_vect_e": {
            "name": "edge vector east",
            "dims": [fv3util.X_DIM, fv3util.Y_DIM],
            "units": "",
        },
        "edge_vect_w": {
            "name": "edge vector west",
            "dims": [fv3util.X_DIM, fv3util.Y_DIM],
            "units": "",
        },
        "vlon": {
    ...
    def compute_parallel(self, inputs, communicator):
        self._base.compute_func = ApplyPhysics2Dycore(
            self.grid, spec.namelist, communicator
        )
        ...
        self._base.compute_func(
            ...
            extra_grid_info["vlon1"],
            extra_grid_info["vlon2"],
            extra_grid_info["vlon3"],
            extra_grid_info["vlat1"],
            extra_grid_info["vlat2"],
            extra_grid_info["vlat3"],
            extra_grid_info["edge_vect_w"],
            extra_grid_info["edge_vect_e"],
            extra_grid_info["edge_vect_s"],
            extra_grid_info["edge_vect_n"],
            extra_grid_info["es1_1"],
            extra_grid_info["es2_1"],
            extra_grid_info["es3_1"],
            extra_grid_info["ew1_2"],
            extra_grid_info["ew2_2"],
