...
PHYSICS_PROPERTIES = json.load(
    open(os.path.join(dirname, "physics_properties.json"), "r")
)
DYNAMICS_PROPERTIES = json.load(
    open(os.path.join(dirname, "dynamics_properties.json"), "r")
)
