...
python3 -m pip install -e ${PACE_DIR}/driver -e ${PACE_DIR}/dsl -e ${PACE_DIR}/fv3core -e ${PACE_DIR}/physics -e ${PACE_DIR}/stencils -e ${PACE_DIR}/util -e ${PACE_DIR}/external/gt4py -c ${PACE_DIR}/constraints.txt
cd ${workdir}
