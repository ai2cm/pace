...
gt4py_tests_gpu:
	CUDA=y make build && \
        docker run --gpus all $(FV3CORE_IMAGE) python3 -m pytest -k "not gtc" -x gt4py/tests/test_unittest gt4py/tests/test_integration gt4py/tests/reference_cpp_regression
