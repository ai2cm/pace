...
cp ${DRIVER_DIR}/examples/configs/baroclinic_c12_write_restart.yaml baroclinic_c12_write_restart.yaml
cp ${DRIVER_DIR}/examples/configs/baroclinic_c12_write_restart.yaml baroclinic_c12_run_two_steps.yaml
