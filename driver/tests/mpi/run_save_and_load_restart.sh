...
mpirun -n 6 --mca btl_vader_single_copy_mechanism none python -m pace.driver.run baroclinic_c12_write_restart.yaml
mpirun -n 6 --mca btl_vader_single_copy_mechanism none python -m pace.driver.run RESTART/restart.yaml
mpirun -n 6 --mca btl_vader_single_copy_mechanism none python -m pace.driver.run baroclinic_c12_run_two_steps.yaml
