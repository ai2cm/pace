...
from fv3core.utils import Quantity
import copy
...
@dataclass()
class PhysicsState:
    qvapor: Quantity = field(metadata={"name": "specific_humidity", "units": "kg/kg", "from_dycore": True})
    qliquid: Quantity = field(metadata={"name": "cloud_water_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": True})
    qice: Quantity = field(metadata={"name": "cloud_ice_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": True}) 
    qrain: Quantity = field(metadata={"name": "rain_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": True})
    qsnow: Quantity = field(metadata={"name": "snow_mixing_ratio","units": "kg/kg", "intent":"inout", "from_dycore": True})
    qgraupel: Quantity = field(metadata={"name": "graupel_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": True}) 
    qo3mr: Quantity = field(metadata={"name": "ozone_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": True}) 
    qsgs_tke: Quantity = field(metadata={"name": "turbulent_kinetic_energy","units": "m**2/s**2", "intent":"inout", "from_dycore": True})
    qcld: Quantity = field(metadata={"name": "cloud_fraction","units": "", "intent":"inout", "from_dycore": True})
    pt: Quantity = field(metadata={"name": "air_temperature", "units": "degK", "intent":"inout", "from_dycore": True})
    delp: Quantity = field(metadata={"name": "pressure_thickness_of_atmospheric_layer", "units": "Pa", "intent":"inout", "from_dycore": True})
    delz: Quantity = field(metadata={"name": "vertical_thickness_of_atmospheric_layer", "units": "m", "intent":"inout", "from_dycore": True}) 
    ua: Quantity = field(metadata={"name": "eastward_wind", "units": "m/s", "intent":"inout", "from_dycore": True})
    va: Quantity = field(metadata={"name": "northward_wind", "units": "m/s", "from_dycore": True })
    w: Quantity = field(metadata={"name": "vertical_wind", "units": "m/s", "intent":"inout", "from_dycore": True})
    omga: Quantity = field(metadata={"name": "vertical_pressure_velocity","units": "Pa/s", "intent":"inout", "from_dycore": True})
    qvapor_t1: Quantity = field(metadata={"name": "physics_specific_humidity", "units": "kg/kg", "from_dycore": False})
    qliquid_t1: Quantity = field(metadata={"name": "physics_cloud_water_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": False})
    qice_t1: Quantity  = field(metadata={"name": "physics_cloud_ice_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": False}) 
    qrain_t1: Quantity =  field(metadata={"name": "physics_rain_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": False})
    qsnow_t1: Quantity = field(metadata={"name": "physics_snow_mixing_ratio","units": "kg/kg", "intent":"inout", "from_dycore": False})
    qgraupel_t1: Quantity = field(metadata={"name": "physics_graupel_mixing_ratio", "units": "kg/kg", "intent":"inout", "from_dycore": False}) 
    qcld_t1: Quantity  = field(metadata={"name": "physics_cloud_fraction","units": "", "intent":"inout", "from_dycore": False})
    pt_t1: Quantity  = field(metadata={"name": "physics_air_temperature", "units": "degK", "intent":"inout", "from_dycore": False})
    ua_t1: Quantity = field(metadata={"name": "physics_eastward_wind", "units": "m/s", "intent":"inout", "from_dycore": False})
    va_t1: Quantity  = field(metadata={"name": "physics_northward_wind", "units": "m/s", "from_dycore": False })
    delprsi: Quantity = field(metadata={"name": "model_level_pressure_thickness_in_physics", "units": "Pa", "from_dycore": False})
    phii: Quantity = field(metadata={"name": "interface_geopotential_height", "units": "m", "from_dycore": False})
    phil: Quantity = field(metadata={"name": "layer_geopotential_height", "units": "m", "from_dycore": False})
    dz: Quantity = field(metadata={"name": "geopotential_height_thickness", "units": "m", "from_dycore": False})
    wmp: Quantity = field(metadata={"name": "layer_mean_vertical_velocity_microph", "units": "m/s", "from_dycore": False})
    prsi: Quantity = field(metadata={"name": "interface_pressure", "units": "Pa", "from_dycore": False})
    ...
    def __post_init__(self, quantity_factory):
        ...
        tendency = quantity_factory.zeros([fv3util.X_DIM, fv3util.Y_DIM, fv3util.Z_DIM],  "unknown", dtype=float)
